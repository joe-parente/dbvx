...
<?php if (isset($this->schema) && count($this->schema)) { ?>
    <form method="post" action="" class="nomargin" id="schema">
        ...
        <?php //if (isset($flags['logging'])) { ?>
        <button data-role="startLog" class="btn btn-primary btn-mini"><?php echo __('Start MySQL general log'); ?></button>
            <button data-role="stopLog" class="btn btn-primary btn-mini"><?php echo __('Stop logging and get changes'); ?></button>
        <?php //} else { ?>
